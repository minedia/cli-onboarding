...
| `claude-code-hackathon` | Claude Code ハッカソン（Biz向け業務効率化） | 約140分 | ✅ 公開中 | [概要](decks/claude-code-hackathon/README.md) |
| `claude-code-steering` | Claude Code を steering する（Skills/Hooks/Rules/Subagents） | 約40分 | ✅ 公開中 | [概要](decks/claude-code-steering/README.md) |
| _（追加予定）_ | — | — | 🚧 | — |
